rpart.control <-
  function(minsplit = 20L, minbucket = round(minsplit/3), minsplitweight = 0, cp = 0.01,
	   ...
	   surrogatestyle = 0L, maxdepth = 30L, ...)
{
    ...
    list(minsplit = minsplit, minbucket = minbucket, minsplitweight = minsplitweight, cp = cp,
